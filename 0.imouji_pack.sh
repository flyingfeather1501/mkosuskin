...
## render images
empties=(count1.png count2.png count3.png default-{0..9}.png hit300-0.png hit300g-0.png hit300k-0.png inputoverlay-background.png lighting.png ranking-graph.png scorebar-bg.png sliderendcircle.png sliderpoint10.png sliderpoint30.png sliderscorepoint.png spinner-bottom.png spinner-clear.png spinner-glow.png spinner-middle.png star2.png)
